...
import {getCoupons} from "../../store/Actions/ActionsAd";
import {getOwnCoupons} from "../../store/Actions/ActionsCl";
//Mui
import{Col,Row} from "react-flexbox-grid";
import {Card, CardActions, CardHeader, CardMedia, CardTitle, CardText} from 'material-ui/Card';
import FlatButton from 'material-ui/FlatButton';
import Paper from 'material-ui/Paper';
import {getEvents, getExceptions} from "../../store/Actions/ActionsAd";
        ...
        return(
            <Fragment>
                ...
                <Paper className={"menuCover"}style={{ height:"110%",
                    ...
                    <Col md={6} className={"cardBG4 "} style={{padding:'50px',borderRadius:'15px',
                    border:"5px double #c59d5f"}}>
                        <h3 style={{fontSize: '1.5em',
                            ...
                            color: '#c8d4ff',
                            fontStyle: 'italic',
                            fontFamily:'Cinzel Decorative,cursive',}}>My Wallet</h3>


                            {
                                this.props.myCoupons.map(
                                    cpn => {
                                        return (
...
const mapDispatchToProps = (dispatch) => {
    return {
        ...
        getOwnCoupons: (i) => dispatch(getOwnCoupons(i)),
    }
};
